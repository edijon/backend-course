...
class PlanningRepositoryDumb(domain.IPlanningRepository):
            ...
            domain.Planning(
                ...
                slots=[
                    domain.PlanningSlot(
                        ...
                        hours_end=10,
                        minutes_end=0,
                        promotion=domain.Promotion(id=domain.PromotionId(id=self.next_identity()), study_year=2, diploma="DEUST", name="Kempf"),
                    ...
                    domain.PlanningSlot(
                        ...
                        hours_end=11,
                        minutes_end=15,
                        promotion=domain.Promotion(id=domain.PromotionId(id=self.next_identity()), study_year=3, diploma="DEUST", name="Smith"),
